...
<body>
    ...
    <div class="body__page">
        ...
        <div class="container__card">
            ...
            <div class="card c1">
                <div class="icon">
                    <img src="img/jugador1.jpg" alt="" onclick="window.location.href = 'NochePlay.php';">
                </div>
            ...
            <div class="card c2">
                <div class="icon">
                    <img src="img/jugador2.jpg" alt="" onclick="window.location.href = 'NochePlayMultyPlayer.php';">
                </div>
                <div class="info__description">
                    <p>Multiplayer</p>
