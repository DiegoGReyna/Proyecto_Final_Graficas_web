...
<head>
    ...
    <!-- <script type="module" src="js/CanvasThreeJsPlayer1Night.jss"></script> -->
    <script type="module" src="js/CanvasThreeJsMultiplayerDifficult.js"></script>
            ...
            <div id="bodyModalAjuste" class="volumen" style="display:none;">
                <div class="Container_TitleSettings">
                    ...
                    <div class="Container_Settigs">
                        <div class="Box_Volume">
                            <div class="BoxInputVolume">
                                <input class="range" type="range" name="InpVolume" id="InpVolume" min="0" max="100" onchange="rangeSlide(this.value)" onmousemove="rangeSlide(this.value)">
                    ...
                    <div class="">
                        ...
                        <input type="button" class="NormalLink" onclick="document.getElementById('bodyModalAjuste').style.display ='none';document.getElementById('bodyModalTableSetting').style.display ='block';" value="Cancelar">
                    </div>
                </div>
